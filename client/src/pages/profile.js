    ...
    return (
        ...
        <div id = "modal2">
            ...
            <div className="modal-right-area">
                <form action = {`${BASE_URL}/uploads`} method="post" enctype="multipart/form-data" target="_parent">
                    ...
                    <textarea name = "description" style = {{height: 140, marginTop: 28, width: 261}} placeholder="description" required></textarea>
        ...
        <div id = "modal" style = {{display: visible2}}>
            ...
            <div className="modal-right-area">
                ...
                <textarea style = {{height: 167, marginTop: 28, width: 261}} value = {description} onChange = { (event) => setDescription(event.target.value)} required>
                </textarea>
                </form>
